...
public class CustomerUpdateFormController {
    ...
    public void btnUpdateCustomer(ActionEvent actionEvent) throws ClassNotFoundException, SQLException {
        ...
        if (new CustomerController().updateCustomer(c1)) new Alert(Alert.AlertType.CONFIRMATION, "Updated...").show();
